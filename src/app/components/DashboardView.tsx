import { AlertTriangle, CheckCircle, ClipboardCheck, FileSignature, MapPin, Package, TrendingUp, TruckIcon } from 'lucide-react';
...
export function DashboardView({ inventoryState }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg p-6 text-white shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Release Status Snapshot</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-100">
              <span className="text-sm font-semibold text-green-900">GPS Confirmed Receipts</span>
              <span className="text-xl font-bold text-green-700">{gpsAcceptedCount}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-100">
              <span className="text-sm font-semibold text-orange-900">Needs Follow-up</span>
              <span className="text-xl font-bold text-orange-700">{activeReleases.length}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
              <span className="text-sm font-semibold text-blue-900">Incoming for Review</span>
              <span className="text-xl font-bold text-blue-700">{incomingForReview}</span>
            </div>
          </div>
        </div>
      </div>
